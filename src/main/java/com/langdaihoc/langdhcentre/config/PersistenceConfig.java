...
import static com.langdaihoc.langdhcentre.config.HibernateConf.getDataSource;

@Configuration
@EnableTransactionManagement
@EnableJpaRepositories(basePackages = { "com.langdaihoc.langdhcentre" }, transactionManagerRef = "jpaTransactionManager", entityManagerFactoryRef = "jpaEntityManager")
//@EnableJpaAuditing(auditorAwareRef = "auditorProvider")
@PropertySource({ "classpath:persistence-mysql.properties" })
@ComponentScan({ "com.langdaihoc.langdhcentre" })
public class PersistenceConfig {

    public static final String COM_LANGDAIHOC_LANGDHCENTRE = "com.langdaihoc.langdhcentre";
    @Autowired
...
//    }
    ...
    public LocalSessionFactoryBean sessionFactory() {
        ...
        sessionFactory.setPackagesToScan(COM_LANGDAIHOC_LANGDHCENTRE);
    ...
    public LocalContainerEntityManagerFactoryBean entityManagerFactory() {
        ...
        emf.setPackagesToScan(COM_LANGDAIHOC_LANGDHCENTRE);
